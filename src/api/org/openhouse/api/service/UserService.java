...
public interface UserService {
     ...
     */
    @Transactional(readOnly=true)
    User getUserByUsername(String username) throws OpenHouseException;    
     ...
     * @throws Exception
     */
    void resetPassword(User user, int size) throws OpenHouseException;
	...
	User getLoggedInUser() throws OpenHouseException;
	boolean validatePassword(User user) throws OpenHouseException;
