	...
	public int doStartTag() throws JspException {
		...
		try {
			if (url.equals(""))
				...
				pageContext.getRequest().setAttribute("org.openhouse.portlet.id", id);
				pageContext.getRequest().setAttribute("org.openhouse.portlet.size", size);
				pageContext.getRequest().setAttribute("org.openhouse.portlet.parameters",
				    OpenhouseUtil.parseParameterList(parameters));
				pageContext.getRequest().setAttribute("org.openhouse.portlet.patientId", patientId);
				pageContext.getRequest().setAttribute("org.openhouse.portlet.personId", personId);
				pageContext.getRequest().setAttribute("org.openhouse.portlet.encounterId", encounterId);
				pageContext.getRequest().setAttribute("org.openhouse.portlet.userId", userId);
				pageContext.getRequest().setAttribute("org.openhouse.portlet.patientIds", patientIds);
				pageContext.getRequest().setAttribute("org.openhouse.portlet.parameterMap", parameterMap);
			}
		}
		catch (IOException e) {
