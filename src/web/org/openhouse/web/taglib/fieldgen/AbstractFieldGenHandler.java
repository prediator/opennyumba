...
import org.openhouse.web.taglib.FieldGenTag;
import org.openhouse.web.taglib.HtmlIncludeTag;
...
public abstract class AbstractFieldGenHandler implements FieldGenHandler {
	...
	protected void setParameter(String s, Object o) {
		if (this.fieldGenTag != null) {
			//HashMap<String,Object> hmParams = (HashMap<String,Object>)getRequest().getAttribute("org.openhouse.fieldGen.parameterMap");
