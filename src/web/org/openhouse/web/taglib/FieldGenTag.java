...
import org.openhouse.web.taglib.fieldgen.FieldGenHandler;
import org.openhouse.web.taglib.fieldgen.FieldGenHandlerFactory;
import org.openhouse.web.taglib.fieldgen.LocationHandler;
...
public class FieldGenTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		pageContext.getRequest().setAttribute("org.openhouse.fieldGen.type", type);
		pageContext.getRequest().setAttribute("org.openhouse.fieldGen.formFieldName", formFieldName);
		pageContext.getRequest().setAttribute("org.openhouse.fieldGen.parameters", OpenhouseUtil.parseParameterList(parameters));
		HashMap<String, Object> hmParamMap = (HashMap<String, Object>) pageContext.getRequest().getAttribute(
		    "org.openhouse.fieldGen.parameterMap");
		if (hmParamMap == null)
			hmParamMap = new HashMap<String, Object>();
		if (this.parameterMap != null)
			hmParamMap.putAll(this.parameterMap);
		pageContext.getRequest().setAttribute("org.openhouse.fieldGen.parameterMap", hmParamMap);
		
		pageContext.getRequest().setAttribute("org.openhouse.fieldGen.object", val);
		pageContext.getRequest().setAttribute("org.openhouse.fieldGen.request", pageContext.getRequest());
	...
	public FieldGenHandler getHandlerByClassName(String className) {
		...
		try {
			//Resource beanDefinition = new ClassPathResource("/web/WEB-INF/openhouse-servlet.xml");
			...
			//ApplicationContext context = new FileSystemXmlApplicationContext("file:/**/WEB-INF/openhouse-servlet.xml");
			//if ( context == null ) context = WebApplicationContextUtils.getWebApplicationContext(this.pageContext.getServletContext());
			//if ( context == null ) context = new FileSystemXmlApplicationContext("file:/**/WEB-INF/openhouse-servlet.xml");
			/*
			if ( context != null ) {
